...
exports.book_list = function (req, res, next) {
  Book.find({}, "title author")
    ...
    .exec(function (err, list_books) {
      ...
      // On success, the callback passed to the query renders the book_list(.pug) template, passing 
      // the title and book_list (list of books with authors) as variables.
